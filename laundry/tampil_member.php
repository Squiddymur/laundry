...
?>
<br>
<h3 align="center" style="color: light-black; font-family:montserrat; font-size: 35px;">Para Member KING LAUNDRY.</h3>
<br>
<div class="row">
    <?php 
    include "koneksi.php";
        ...
        <div class="col-md-3">
            <div class="card" >
              <div class="card-body">
                ...
                <br>
                <h5 style="color: light-black; font-family:montserrat; font-size: 20px;" class="card-title"><?=$data_member['alamat']?></h5>
                <br>
                <h5 style="color: light-black; font-family:montserrat; font-size: 15px;" class="card-text"><?=substr($data_member['telp'], 0,20)?></h5>
                <br>
                <h5 style="color: light-black; font-family:montserrat; font-size: 20px;" class="card-text">Jenis Kelamin : <?=substr($data_member['jk'], 0,20)?></h5>
                <br>
